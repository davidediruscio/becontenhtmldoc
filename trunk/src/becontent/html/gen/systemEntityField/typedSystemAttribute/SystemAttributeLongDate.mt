...
<%script type="becontent.SystemAttributeLongDate" name="generate" post="trim()"%>
...
<%script type="becontent.SystemAttributeLongDate" name="SystemAttributeLongDate" file="<%cleaner(current().generateFilename())%>"%>
 <%if (name != null && name != ""){%>
