...
<%script type="becontent.SystemAttributeText" name="generate" post="trim()"%>
...
<%script type="becontent.SystemAttributeText" name="SystemAttributeText" file="<%cleaner(current().generateFilename())%>"%>
